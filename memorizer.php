...
class WP_Memorizer {
	...
	private function __construct() {
		...
		add_action( 'enqueue_block_editor_assets', [ $this, 'memorizer_shortcode_block_cgb_editor_assets' ] );
	 ...
	 * Add guten-block
	 */
	function memorizer_shortcode_block_cgb_editor_assets() {
		wp_enqueue_script( 'memorizer_shortcode_block-cgb-block-js', plugin_dir_url( __FILE__ ) . '/assets/js/blocks.build.js', array(
			'wp-blocks',
			'wp-i18n',
			'wp-element',
			'wp-editor'
